...
( 'dongwoo.park@example.com', 'hashed_password_03', '박동우', '동우의여행기', '1992-06-30', NULL,
  'is_black', '2025-02-15', '2023-12-20', NULL, 5, TRUE),

( 'soyeon.han@example.com', 'hashed_password_06', '한소연', '소연의책방', '1994-12-05', NULL,
...
( 'minseok.yoon@example.com', 'hashed_password_01', '윤민석', '민석의하루', '1995-04-23',
...
( 'yuna.song@example.com', 'hashed_password_08', '송유나', '유나의하루', '1996-03-27', NULL,
